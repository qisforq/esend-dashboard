...
CREATE  TABLE "public".unapproved_users ( 
	id                   integer GENERATED BY DEFAULT AS IDENTITY  NOT NULL ,
	first_name           text   ,
	last_name            text   ,
	google_profile_id    text  NOT NULL ,
	joined               timestamptz DEFAULT CURRENT_TIMESTAMP NOT NULL ,
	CONSTRAINT unapproved_users_pkey PRIMARY KEY ( id ),
	CONSTRAINT unnaproved_google_profile_id_is_unique UNIQUE ( google_profile_id ) 
 );
